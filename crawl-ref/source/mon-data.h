...

{
    ...
    { {AT_STING, AF_POISON_MEDIUM, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
...

{
    ...
    { 6, 4, 6, 0 },
    3, 10, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    2, 12, MST_SATYR, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Nonbase draconian AC and EV is additive with the base type.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 3, 0 },
    0, 0, MST_DRAC_CALLER, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 16, 6, 3, 0 },
    -3, 10, MST_NO_SPELLS, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    3, 0, MST_DRACONIAN_ZEALOT, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 4, 0 },
    -1, 6, MST_DRAC_SHIFTER, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    -1, 0, MST_DEEP_ELF_ANNIHILATOR, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 16, 6, 2, 0 },
    3, 2, MST_NO_SPELLS, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    -1, 2, MST_DRAC_SCORCHER, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 2, 2, 0 },
    1, 20, MST_SPRIGGAN_DRUID, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},
...
{
    MONS_DROWNED_SOUL, 'p', LIGHTCYAN, "drowned soul",
    M_SENSE_INVIS | M_INSUBSTANTIAL | M_SPEAKS,
    mrd(MR_RES_COLD, 3),
...

{
    ...
    { {AT_STING, AF_POISON_MEDIUM, 30}, {AT_CLAW, AF_PLAIN, 15},
...

{
    ...
    MR_RES_POISON,
    1000, 14, MONS_NAGA, MONS_NAGA, MH_NATURAL, -6,
    { {AT_SHOOT, AF_PLAIN, 17}, {AT_HIT, AF_PLAIN, 17},
...
{
    MONS_SHAMBLING_MANGROVE, 'P', LIGHTRED, "shambling mangrove",
    M_SPELLCASTER | M_FAKE_SPELLS,
    MR_RES_POISON,
...
// fake R - conjured by the R's illusion spell.
{
    ...
    { {AT_HIT, AF_PLAIN, 0}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    0, 30, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_BITE, AF_ELEC, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 3, 5, 0 },
...

{
    ...
    MR_RES_POISON,
    450, 10, MONS_SNAKE, MONS_MANA_VIPER, MH_NATURAL, MAG_IMMUNE,
    { {AT_BITE, AF_ANTIMAGIC, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 3, 5, 0 },
    3, 14, MST_NO_SPELLS, CE_MUTAGEN, Z_SMALL, S_HISS,
...

{
    ...
    M_NO_SKELETON | M_COLD_BLOOD | M_FIGHTER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    6, 12, MST_NO_SPELLS, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 4, 0 },
    3, 13, MST_NO_SPELLS, CE_POISON_CONTAM, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// those of the relevant base demonspawn type.
{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 0, 0 },
    0, 0, MST_DEMONSPAWN_BLOOD_SAINT, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 1, 0 },
    0, 0, MST_DEMONSPAWN_CHAOS_CHAMPION, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 1, 2, 0 },
    0, 2, MST_DEMONSPAWN_WARMONGER, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 1, 0 },
    0, 0, MST_DEMONSPAWN_CORRUPTER, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 0, 0 },
    3, 13, MST_DEMONSPAWN_BLACK_SUN, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// gargoyles ('9')
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, {AT_BITE, AF_PLAIN, 10}, {AT_CLAW, AF_PLAIN, 6},
       AT_NO_ATK },
    { 4, 3, 5, 0 },
...

{
    ...
    { {AT_HIT, AF_FIRE, 12}, {AT_BITE, AF_FIRE, 12}, {AT_CLAW, AF_FIRE, 8},
       AT_NO_ATK },
    { 5, 3, 5, 0 },
...
// "h" - carnivorous quadrupeds
{
    ...
    { {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 5, 0, 0 },
    2, 12, MST_NATASHA, CE_CONTAMINATED, Z_SMALL, S_HISS,
    I_HIGH, HT_LAND, FL_NONE, 10, MOVE_ENERGY(8),
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LITTLE
},
...
{
    MONS_ASTERION, 'H', ETC_FIRE, "Asterion", // Really ETC_MAKHLEB; H is full
    ...
    { 15, 0, 0, 150 },
    5, 7, MST_ASTERION, CE_CONTAMINATED, Z_SMALL, S_BELLOW,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
