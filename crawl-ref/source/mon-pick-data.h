...
{ // Dungeon (OOD cap: 27)
  ...
  { 16, 22,   89, PEAK, MONS_KOBOLD_DEMONOLOGIST },
  ...
  { 16, 26,  345, DOWN, MONS_ORC_KNIGHT },
...
{ // Snake Pit
  ...
  {  3,  7,   90, PEAK, MONS_SALAMANDER_MYSTIC },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Vaults (OOD cap: 12)
  ...
  {  1,  2,  413, FLAT, MONS_CYCLOPS },
  {  1,  2,  167, FLAT, MONS_MOTTLED_DRAGON },
  ...
  {  1, 11,  577, DOWN, MONS_IRONHEART_PRESERVER },
...
{ // Pandemonium
  ...
  {  1,  1,  800, FLAT, MONS_MONSTROUS_DEMONSPAWN },
  {  1,  1,  800, FLAT, MONS_GELID_DEMONSPAWN },
  {  1,  1,  800, FLAT, MONS_INFERNAL_DEMONSPAWN },
  {  1,  1,  800, FLAT, MONS_PUTRID_DEMONSPAWN },
  {  1,  1,  800, FLAT, MONS_TORTUROUS_DEMONSPAWN },
...
{ // Depths (OOD cap: 14)
  ...
  { -1,  3,  150, SEMI, MONS_HILL_GIANT },
  { -1,  3,  100, SEMI, MONS_VAMPIRE },
  {  1,  3,  300, DOWN, MONS_UGLY_THING },
  {  1,  4,  250, DOWN, MONS_CENTAUR_WARRIOR },
  {  1,  4,  300, DOWN, MONS_OGRE_MAGE },
  {  1,  6,  250, DOWN, MONS_YAKTAUR },
  {  1,  6,  250, UP,   MONS_YAKTAUR_CAPTAIN },
  {  1,  6,  300, DOWN, MONS_SHAPESHIFTER },
  {  1,  6,  250, FLAT, MONS_DEEP_TROLL_SHAMAN },
  {  1,  6,  250, FLAT, MONS_DEEP_TROLL_EARTH_MAGE },
  ...
  {  2,  8,  150, SEMI, MONS_SPRIGGAN_AIR_MAGE },
  {  2,  8,  215, SEMI, MONS_SPRIGGAN_BERSERKER },
  {  3, 14,   40, FLAT, MONS_SPRIGGAN_DEFENDER },
  {  4, 14,   80, SEMI, MONS_TENTACLED_MONSTROSITY },
  {  4, 14,   40, FLAT, MONS_STORM_DRAGON },
  {  4, 14,   40, FLAT, MONS_SHADOW_DRAGON },
  {  4, 14,   25, FLAT, MONS_BONE_DRAGON },
